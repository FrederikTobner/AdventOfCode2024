...
TEST_F(AntinodesTest, DiscreteAntinodesSimplePattern) {
    // Arrange
    std::multimap<char, aoc::math::vector_2d<int64_t>> antenas{{'1', {0, 0}}, {'1', {2, 2}}};

    // Act
    auto result = aoc::day_8::findDiscreteAntinodes(5, 5, antenas);

    // Assert
    EXPECT_THAT(result, testing::UnorderedElementsAre(aoc::math::vector_2d<int64_t>{4, 4}));
}
...
TEST_F(AntinodesTest, DiscreteAntinodesMultipleFrequencies) {
    ...
    // Assert
    EXPECT_THAT(result, testing::UnorderedElementsAre(aoc::math::vector_2d<int64_t>{4, 4},
                                                      aoc::math::vector_2d<int64_t>{5, 5}));
}

TEST_F(AntinodesTest, ContinuousAntinodesSimplePattern) {
    // Arrange
    std::multimap<char, aoc::math::vector_2d<int64_t>> antenas{{'1', {0, 0}}, {'1', {1, 1}}};
    ...
    EXPECT_THAT(result, testing::UnorderedElementsAre(
                            aoc::math::vector_2d<int64_t>{0, 0}, aoc::math::vector_2d<int64_t>{1, 1},
                            aoc::math::vector_2d<int64_t>{2, 2}, aoc::math::vector_2d<int64_t>{3, 3}));
}
...
TEST_F(AntinodesTest, OutOfBoundsAntinodesAreFiltered) {
    // Arrange
    std::multimap<char, aoc::math::vector_2d<int64_t>> antenas{{'1', {0, 0}}, {'1', {3, 3}}};
...
TEST_F(AntinodesTest, SingleAntennaHasNoAntinodes) {
    // Arrange
    std::multimap<char, aoc::math::vector_2d<int64_t>> antenas{{'1', {2, 2}}};
