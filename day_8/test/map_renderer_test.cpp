...
TEST_F(MapRendererTest, GridWithSingleAntinode) {
    // Arrange
    std::vector<std::string_view> lines = {"123", "456", "789"};
    std::unordered_set<aoc::math::vector_2d<int64_t>> antinodes{{1, 1}};
...
TEST_F(MapRendererTest, GridWithMultipleAntinodes) {
    // Arrange
    std::vector<std::string_view> lines = {"123", "456", "789"};
    std::unordered_set<aoc::math::vector_2d<int64_t>> antinodes{{0, 0}, {2, 2}};
...
TEST_F(MapRendererTest, LargeGridWithBoundaryAntinodes) {
    // Arrange
    std::vector<std::string_view> lines = {".....", ".....", ".....", "....."};
    std::unordered_set<aoc::math::vector_2d<int64_t>> antinodes{{0, 0}, {0, 4}, {3, 0}, {3, 4}};
