...
getOtherAntennaPositionsByFrequency(char frequency, aoc::math::vector_2d<int64_t> const & exclude_pos,
                                    std::multimap<char, aoc::math::vector_2d<int64_t>> const & antenas) {
    ...
    return std::ranges::subrange(range.first, range.second) |
           ...
           std::views::filter(
               [&exclude_pos](aoc::math::vector_2d<int64_t> const & pos) { return pos != exclude_pos; }) |
           std::views::common;
}
...
[[nodiscard]] static auto inBounds(aoc::math::vector_2d<int64_t> vec, int64_t max_x, int64_t max_y) -> bool {
...
[[nodiscard]] static auto generateAntinodeSequence(aoc::math::vector_2d<int64_t> start,
                                                   aoc::math::vector_2d<int64_t> diff, int64_t max_x, int64_t max_y) {
    return std::views::iota(0) | std::views::transform([=](int64_t i) { return start + diff * i; }) |
           std::views::take_while(
               [=](aoc::math::vector_2d<int64_t> pos) { return detail::inBounds(pos, max_x, max_y); });
}
} // namespace detail
...
[[nodiscard]] auto findDiscreteAntinodes(int64_t max_x_coordinate, int64_t max_y_coordinate,
                                         std::multimap<char, aoc::math::vector_2d<int64_t>> const & antenas)
    -> std::unordered_set<aoc::math::vector_2d<int64_t>> {
    return std::views::transform(
               antenas,
               [&](auto const & antena) {
                   return detail::getOtherAntennaPositionsByFrequency(antena.first, antena.second, antenas) |
                          std::views::transform([&antena](aoc::math::vector_2d<int64_t> const & other_coordinate) {
                              return other_coordinate + other_coordinate - antena.second;
                          }) |
                          std::views::filter(
                              [max_x_coordinate, max_y_coordinate](aoc::math::vector_2d<int64_t> const & pos) {
                                  return detail::inBounds(pos, max_x_coordinate, max_y_coordinate);
                              });
               }) |
           std::views::join | aoc::ranges::to<std::unordered_set<aoc::math::vector_2d<int64_t>>>;
}
...
[[nodiscard]] auto findContinousAntinodes(int64_t max_x_coordinate, int64_t max_y_coordinate,
    ...
    return std::views::transform(
               ...
               [&](auto const & antena) {
                   return detail::getOtherAntennaPositionsByFrequency(antena.first, antena.second, antenas) |
                          std::views::transform([&](aoc::math::vector_2d<int64_t> const & other_coordinate) {
