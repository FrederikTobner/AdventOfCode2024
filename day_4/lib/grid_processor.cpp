...
[[nodiscard]] auto aoc::day_4::processLines(std::string const & input) -> std::vector<std::string_view> {
...
[[nodiscard]] auto aoc::day_4::validateGrid(std::span<std::string_view const> lines) -> bool {
